...
public class UpdateFieldPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory
{
    ...
    public UpdateFieldPostFunctionFactory() {
        ...
        log.error("©Update postfunction Factory");
    }

    /*
    public UpdateFieldPostFunctionFactory(WorkflowManager workflowManager) {
    ...
    */
    ...
    protected void getVelocityParamsForInput(Map<String, Object> velocityParams) {
        ...
        log.error("EID : Trace of VelocityParamsForInput");
    ...
    protected void getVelocityParamsForView(Map<String, Object> velocityParams, AbstractDescriptor descriptor) {
        ...
        log.error("EID : race of VelocityParamsForView");
    }
